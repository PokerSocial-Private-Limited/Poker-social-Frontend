...
export function PostCardActions({
  ...
  return (
    <>
          ...
          <Modal.Body>
            <VStack space={3}>
              ...
              {locationModal ? (
                <HStack alignItems="center">
                  <Input
                    onChangeText={(location) => setTaggedLocation(location)}
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
        <Modal.Content maxWidth="450" width="100%" bg="#0E121C">
          <Modal.CloseButton />
          <Modal.Header bg="#0E121C">Share Post</Modal.Header>
          <Modal.Body>
            <VStack space={3}>
              <View>
                <HStack alignItems="center">
